...
export default function Component() {
    return (
        <footer className="grid grid-cols-4 items-start py-4 bg-black/40 text-white px-10 gap-x-8">
...
function DiscordIcon() {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-discord"
             viewBox="0 0 16 16">
            <path
