            ...
            <div className="grid md:grid-cols-2 mx-auto ">
                ...
                <Accordion type={"single"} collapsible className="w-full">
                    <AccordionItem value="item 1">
                        ...
                        <AccordionContent className="font-inter px-4 text-base">A little bumpy start but not OG's fault really, their support team were amazing and sorted everything straight away! Thanks for the great care and attention you guys give and support offered...you can trust them and my team were amazing! Thx folks!
