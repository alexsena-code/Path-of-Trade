...
const jsonLd = {
  ...
  description:
    "Buy Path of Exile Currency Safely ✔️ Lowest Prices for Divine Orbs, Exalts & Chaos. Instant Delivery, 24/7 Live Support. POE Trade Currency Securely at PathOfTrade.net!",
};
